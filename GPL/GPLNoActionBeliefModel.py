...
class GPLNoActionBeliefModel(BeliefModel):
    def __init__(self,
                 action_space,
                 nr_inputs,
                 agent_inputs,
    ...
    def propagate(self, observation, reward, actions, previous_latent_state, other_actions,
                  state_agent_existence, eval=False, with_resample=True):
        """
        ...
        updated_agent_flags, proposed_agent_log_existence, agent_existence_logits, proposed_agent_existence_entropy, s_rep_sample, s_rep_dist, agent_state_existence_logs = \
            self.proposal_state_prediction_network(
                ...
                temperature = self.agent_existence_temperature, eval = eval
            )
        ...
        new_log_weight = agent_existence_component + state_component + \
    ...
    def forward(self, observation_states, previous_latent_state, current_latent_state, temperature=1.0, eval=False):
        ...
        for agent_offset in range(1, num_agent):
            ...
            if not eval:
                ...
                added_probs_states_logits = self.logit_net(input_logit_state_data).view(batch_size, num_particles, 1,
                                                                                        -1)
