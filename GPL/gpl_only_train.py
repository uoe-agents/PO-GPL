...
parser.add_argument('--num-collection-threads', type=int, default=16, help="Number of parallel threads for training.")
...
parser.add_argument('--target-network-update-frequency', type=int, default=100,
                    help="Number of updates before target network is updated (only used if hard updates are applied).")
...
parser.add_argument('--eval-seed', type=int, default=500, help="Environment seed for evaluation.")
