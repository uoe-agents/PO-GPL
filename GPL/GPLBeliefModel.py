...
class GPLBeliefModel(BeliefModel):
    def __init__(self,
                 action_space,
                 nr_inputs,
                 agent_inputs,
    ...
    def propagate(self, observation, reward, actions, previous_latent_state, other_actions, state_agent_existence, with_resample=True, eval=False):
        """
